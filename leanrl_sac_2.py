                ...
                wandb.log(
                    {
                        ...
                        "losses/qf_loss": out["qf_loss"].mean(),
                        "gradients/actor_norm": grad_norm(actor_optimizer),
                        "gradients/qf_norm": grad_norm(q_optimizer),
                        "monitoring/alpha": alpha,
                        "monitoring/q_vals_mean": out["qvals"].mean(),
                        "monitoring/q_vals_min": out["qvals"].min(),
                        "monitoring/q_vals_max": out["qvals"].max(),
